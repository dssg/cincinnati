...
$PATH_TO_MODEL -c $PATH_TO_EXP/all_freq_features_50m_3months_12_13.yaml -n $CORES -p && $PATH_TO_CLEAN && mailme 'exp 2.5';
...
$PATH_TO_MODEL -c $PATH_TO_EXP/all_freq_features_all_spatiotemporal_params_12_13.yaml -n $CORES -p && $PATH_TO_CLEAN && mailme 'exp 3.5';
