...
def parse_feature_pattern_list(patterns):
    '''
        Parses a list of patterns and returns a single list with tuples
...
def check_date_boundaries(con, n_months, table, date_column):
    ...
    min_insp, max_insp = boundaries_for_table_and_column(insp_table,
                                                         'inspection_date')
    ...
    # Compare using time.mktime to avoid errors due to
    # datetime.date with datetime.datetime comparisons
